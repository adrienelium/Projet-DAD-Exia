...
public class TraitementTauxConfiance implements ITraitement<Double> {
    ...
    public TraitementTauxConfiance() {
        ...
        ConnexionBDDSql connexion = new ConnexionBDDSql();
        this.listeMotsDeLaBDD = connexion.getListMot();
        //System.out.println("Ma liste de mots :" + listeMotsDeLaBDD);
    }
        ...
        for(String word : clearText.split(" ")) {
            ...
            if(nombreDeMots <= this.nombreDeMotsMaxAAnalyserDansLeFichier){
                if(isValidWord(word)){
                    ...
                    if(compareStringToBDD(word, this.listeMotsDeLaBDD)){
